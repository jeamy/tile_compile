...
const PAGE_BINDINGS = {
  ...
  "index.html": [
    ...
    { selector: "label[for='dashboard-input-dirs'], .ps-row label", key: "ui.field.input_dirs", index: 0 },
    { selector: ".ps-row label", key: "ui.field.runs_dir", index: 1 },
    { selector: ".ps-row label", key: "ui.field.color_mode", index: 2 },
    { selector: ".ps-inline-label", key: "ui.field.preset" },
    { selector: ".ps-row label", key: "ui.field.run_name", index: 3 },
    { selector: ".ps-row label", key: "ui.field.run_path_preview", index: 4 },
