...
const CONTROL_TEXT_KEYS = {
  ...
  "parameter.situation_apply": "ui.button.situation_apply",
  "parameter.save": "ui.button.save",
  "parameter.save_as": "ui.button.save_as",
...
const CONTROL_TITLE_KEYS = {
  ...
  "parameter.situation_apply": "ui.tooltip.parameter.situation_apply",
  "parameter.save_as": "ui.tooltip.parameter.save_as",
...
const PAGE_BINDINGS = {
  ...
  "wizard.html": [
    ...
    { selector: "a[data-control='nav.parameter_studio']", key: "ui.button.open_parameter_studio", all: true },
  ...
  "run-monitor.html": [
    ...
    { selector: "#monitor-run-summary-batch-title", key: "page.run_monitor.batch" },
    { selector: "#monitor-run-summary-structure-title", key: "page.run_monitor.directory_structure" },
    { selector: "#monitor-start", key: "ui.button.run_start" },
    { selector: "#monitor-stop", key: "ui.button.stop" },
    { selector: "#monitor-live-log-title", key: "ui.nav.live_log" },
    { selector: "#monitor-stats-title", key: "page.run_monitor.stats" },
    { selector: "#monitor-stats-note", key: "monitor.stats.command_hint" },
    ...
    { selector: "#monitor-resume-title", key: "page.run_monitor.resume_revision" },
    { selector: "#monitor-resume-note", key: "page.run_monitor.resume_note" },
    { selector: "#monitor-resume-config-revision-label", key: "ui.field.resume_config_revision" },
    { selector: "#monitor-resume-preset-select-label", key: "page.run_monitor.template" },
    { selector: "#monitor-resume-preset-dir-label", key: "ui.field.preset_dir" },
    { selector: "#monitor-resume-config-editor-label", key: "page.run_monitor.resume_config" },
    ...
    { selector: "#monitor-artifacts-title", key: "page.run_monitor.artifacts" },
    { selector: "#monitor-report", key: "ui.button.report" },
    { selector: "#monitor-open-run-folder", key: "ui.button.open_run_folder" },
    { selector: "#monitor-artifact-viewer-title", key: "page.run_monitor.artifact" },
  ...
  "raw-stack.html": [
    { selector: "document:title", key: "page.raw_stack.title" },
    { selector: "main > .intro", key: "page.raw_stack.intro" },
    { selector: ".app-content > h2", key: "page.raw_stack.heading" },
    { selector: ".app-content > .ps-sub", key: "page.raw_stack.sub" },
    { selector: "#raw-stack-run-queue-title", key: "page.input_scan.queue_title" },
    { selector: "#raw-stack-calibration-title", key: "page.input_scan.calibration_title" },
    { selector: "#raw-stack-quality-title", key: "page.raw_stack.quality" },
    { selector: "#raw-stack-stack-title", key: "page.raw_stack.stack" },
    { selector: "#raw-stack-postprocess-title", key: "page.raw_stack.postprocess" },
    { selector: "#raw-stack-parameters-title", key: "page.raw_stack.parameters" },
    { selector: "#raw-stack-monitor-title", key: "page.raw_stack.monitor" },
    { selector: "#btn-scan", key: "page.input_scan.scan_button" },
    { selector: "#raw-stack-start", key: "ui.button.run_start" },
    { selector: "#raw-stack-cancel", key: "ui.button.stop" },
    { selector: "#raw-stack-open-report", key: "ui.button.report" },
    { selector: "#raw-stack-load-defaults", key: "page.raw_stack.btn_defaults" },
    { selector: "#raw-stack-validate-params", key: "ui.button.validate" },
    { selector: "#raw-stack-reset-defaults", key: "ui.button.reset_default" },
    { selector: ".footer-note", key: "page.raw_stack.footer" },
  ],
  "pcc.html": [
  ...
  "parameter-studio.html": [
    ...
    { selector: "#parameter-situation-title", key: "page.parameter_studio.situation_assistant" },
