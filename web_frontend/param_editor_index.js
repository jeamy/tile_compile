window.PARAM_EDITOR_INDEX = [
  ...
  {
    "category": "assumptions",
    "description": "Schwelle fuer Full Mode: frames_min..(threshold-1) = Reduced Mode, ab threshold = Full Mode.",
    "minimum": 1,
  ...
  {
    "category": "assumptions",
    "description": "K-Suchbereich fuer Reduced-Mode-Clustering, wenn Clustering nicht uebersprungen wird.",
  ...
  },
  {
    ...
    "path": "bge.sample_estimator",
    "source": "schema",
    "type": "string",
    "yaml_default": "quantile"
  },
  {
    "category": "bge",
    "exclusiveMinimum": 0,
  ...
  {
    "category": "registration",
    "description": "Global transform family used after correspondences are found. similarity is stricter and fits equatorial data well; affine is more tolerant for rotating Alt/Az sessions.",
    "enum": [
      "similarity",
      "affine"
    ],
    "path": "registration.transform_model",
    "source": "schema",
    "type": "string",
    "yaml_default": "similarity"
  },
  {
    "category": "registration",
