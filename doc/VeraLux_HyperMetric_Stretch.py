...
class HistogramOverlay(QWidget):
    ...
    def set_data(self, img_data):
        ...
        # Check LE for the general flag (used for bars logic later)
        le_critical = False
...
class VeraLuxInterface:
    def __init__(self, siril_app, qt_app):
        ...
        if hasattr(self, "spin_exp"):
            self.spin_exp.setValue(0.0)
        if hasattr(self, "slide_exp"):
            self.slide_exp.setValue(0)
        try:
    ...
    def get_effective_params(self):
        ...
        if self.radio_ready.isChecked():
            ...
            linear_expansion = self.spin_exp.value() if hasattr(self, "spin_exp") else 0.0
    ...
    def update_mode_ui(self):
        ...
        if hasattr(self, "spin_exp") and hasattr(self, "slide_exp"):
    ...
    def update_main_stats(self, img_data, mode):
        ...
        if mode != "ready_to_use" and hasattr(self, "spin_exp") and self.spin_exp.value() > 0:
    ...
    def print_help_to_console(self):
        guide_lines = [
            "==========================================================================",
            "   VERALUX HYPERMETRIC STRETCH v1.4 - OPERATIONAL GUIDE",
