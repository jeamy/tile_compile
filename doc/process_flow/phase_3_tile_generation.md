...
| `tile.star_min_count` | historischer Schwellwert / Default-Basis für STAR-Support | 3 |
| `tile.star_soft_count` | Soft-Count für weiches STAR/STRUCT-Blending | typischerweise = `tile.star_min_count` |
