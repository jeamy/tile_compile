...
constexpr PhaseInfo METHODIK_V4_PHASES[] = {
    ...
    {10, "SYNTHETIC_FRAMES", "Synthetische Frames"},
    {11, "STACKING", "Finales lineares Stacking"},
    {12, "DEBAYER", "Debayer / Demosaicing"},
    {13, "ASTROMETRY", "Astrometrie (Plate Solve)"},
    {14, "PCC", "Photometrische Farbkalibrierung"},
    {15, "DONE", "Abschluss"},
};
