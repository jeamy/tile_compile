...
words = [
    ...
    "min_sample_bg_value", "min_size", "min_snr", "min_stars", "min_tile_weight_variance", "min_tiles_per_cell",
    ...
    "reject_shift_px_min", "require_no_tile_pattern", "robust_loss", "roundness", "sample_estimator", "sample_quantile",
