...
ROOT="${BUNDLE_DIR}/tile_compile_gui3-windows-${TAG}"
...
assemble_bundle() {
  ...
  cp "${PROJECT_ROOT}/packaging/gui3/start_gui3.bat" "${ROOT}/start_gui3.bat"
  cp "${PROJECT_ROOT}/packaging/gui3/start_gui3.ps1" "${ROOT}/start_gui3.ps1"
...
smoke_test() {
  ...
  powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "
    ...
    \$env:TILE_COMPILE_GUI3_NO_BROWSER = '1'
    \$env:TILE_COMPILE_GUI3_PORT = '${PORT}'
    \$startScript = Join-Path \$root 'start_gui3.ps1'
    \$launcher = \$null
    try {
...
create_zip() {
  ...
  dst_win="$(cygpath -w "${ARTIFACTS_DIR}/tile_compile_gui3-windows-${TAG}.zip")"
  powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "
    \$ErrorActionPreference = 'Stop'
    \$src = '${src_win}'
    \$dst = '${dst_win}'
...
main() {
  ...
  create_zip
  echo "[gui3-package] Created ${ARTIFACTS_DIR}/tile_compile_gui3-windows-${TAG}.zip"
}
