# Strategien, um die stacking programm-Sternschärfe zu erreichen
...
- stacking programm-Referenz `result.fit` / `resultHMS.fit`

---

## 1. Ausgangslage

Das stacking programm-Bild ist nicht nur durch einen besseren Schärfefilter schärfer. Die entscheidende Differenz liegt in der Pipeline-Domäne:
...
| Strategie | Schärfe-Potenzial | Wahrscheinlichkeit, stacking programm zu erreichen | Risiko | Empfehlung |
|---|---:|---:|---:|---|
...
**Strategie 3 hat wahrscheinlich das höchste theoretische Schärfe-Potenzial.** Sie ist aber nicht automatisch der wahrscheinlichste oder schnellste Weg, mindestens stacking programm-Niveau zu erreichen.
...
Das bedeutet, dass die Daten grundsätzlich Subpixel-Information über mehrere Bayer-Phasen enthalten können. Ob diese Information ausreichend gleichmäßig verteilt ist, muss aber noch geprüft werden. Eine reine Schätzung „98 % gedithert = stacking programm-Schärfe garantiert“ wäre falsch.
...
- entspricht der stacking programm-Domäne wesentlich besser;
...
Das ist der beste erste echte Architekturtest, wenn das Ziel eine hohe Wahrscheinlichkeit für stacking programm-ähnliche Sternprofile ist.
...
Das ist kein vollständiger stacking programm-Pfad, kann aber Registrierungsfehler und Subpixel-Alignment verbessern.
...
- den stacking programm-Vorteil teilweise oder sogar vollständig erreichen.
...
Edge-Aware, VNG oder ein hochwertiger Raw-Demosaicer sind sinnvoll. Allein werden sie aber die stacking programm-Lücke wahrscheinlich nicht schließen.
...
> Welche Strategie hat die höchste Chance, mindestens stacking programm-Schärfe zu erreichen?
