...
| `bge.method` | `postprocess.bge` | `none` deaktiviert den Postprocess-Schalter, `classic`/`autobge` aktivieren ihn (einziger Ein-/Ausschalter, kein Legacy-Fallback mehr) |
